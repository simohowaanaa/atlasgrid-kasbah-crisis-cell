...
Voir la [galerie de toutes les captures](GALERIE_CAPTURES.md) et les fiches détaillées dans [`preuves/`](../preuves/), [`fausses pistes`](../triage/fausses_pistes/), [`bruits`](../triage/bruits/) et [`décisions`](../decisions/).

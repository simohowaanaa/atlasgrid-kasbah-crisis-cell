...
![Décision 1](01_isoler_FIN-112_sous_tension.png)

### 2. Isolement ciblé des segments critiques

![Décision 2](02_isoler_segments_critiques.png)

### 3. Communication interne mesurée

![Décision 3](03_communication_interne_rassurer_sans_detail.png)

### 4. OT maintenu sous surveillance renforcée

![Décision 4](04_OT_surveillance_renforcee_sans_coupure.png)

### 5. Déclaration immédiate à l'assureur

![Décision 5](05_declaration_assureur_immediate.png)

### 6. Réponse factuelle à la presse

![Décision 6](06_communication_presse_repondre_version.png)

### 7. Réponse prudente au client

![Décision 7](07_reponse_client_rester_factuel.png)

### 8. Notification transparente à l'Autorité

![Décision 8](08_notification_autorite_transparente.png)

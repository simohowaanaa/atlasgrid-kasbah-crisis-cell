...
![A-11](01_A11_entetes_phishing_atlasgrid-it.png)
...
![Décision SOC](01_isoler_FIN-112_sous_tension.png)

## Fausses pistes investiguées puis écartées

### A-19 — Clé USB du parking, non connectée au SI

![A-19](03_A19_cle_USB_parking_sandbox.png)

### A-20 — Vrai courriel de migration Exchange

![A-20](05_A20_courriel_migration_legitime.png)

### A-14 — Badge datacenter non fiable

![A-14](06_A14_badge_DATACENTER_non_fiable.png)

### A-17 — Copie de paie locale autorisée

![A-17](07_A17_USB_paie_sauvegarde_autorisee.png)

### A-20 — Copie archivistique de la vérification du courriel

![A-20 — copie](09_A20_courriel_migration_legitime_copie.png)

### A-16 — Pic de trafic expliqué par la presse

![A-16](17_A16_pic_trafic_presse_legitime.png)

## Bruits enregistrés, sans lien MIRAGE

### A-21 — Scans Internet génériques

![A-21](20_A21_scans_internet_generiques.png)

### A-25 — PsExec de maintenance autorisée

![A-25](21_A25_PsExec_maintenance_autorisee.png)

### A-27 — Archivage trimestriel autorisé

![A-27](22_A27_archivage_trimestriel_autorise.png)

### A-26 — Connexion Paris légitime

![A-26](24_A26_connexion_Paris_legitime.png)

### A-40 — Ticket OasisNet d'un autre client

![A-40](25_A40_ticket_OasisNet_autre_client.png)

### A-41 — Assistance distante autorisée

![A-41](29_A41_assistance_distance_autorisee.png)

### A-22 — Faux positif CoinMiner

![A-22](30_A22_faux_positif_cryptominer.png)
